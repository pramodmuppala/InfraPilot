...
append_csv_row "$RESULTS_CSV" "${RUN_ID},${SCENARIO},${status},${start_iso},${end_iso},${duration},1,${deployment_id},,${healthy_count},${unhealthy_count},scaled down to 1"
